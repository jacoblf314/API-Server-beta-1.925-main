...
export default class APIServer {
    ...
    initMiddlewaresPipeline() {
        ...
        const cachedRequestsMiddleware = async (HttpContext) => {
            return CachedRequestsManager.get(HttpContext);
        };
    
        this.middlewaresPipeline.add(cachedRequestsMiddleware);
    ...
    async handleHttpRequest(req, res) {
        ...
        if (CachedRequestsManager.get(this.httpContext)) {
            return; 
        }
